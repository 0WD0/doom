...
(doom! :input
       ...
       neoscroll           ; my smooth-scroll module
       ...
       ;; term             ; basic Serminal emulator for Emacs
       vterm               ; the best terminal emulation in Emacs

       :checkers
       ;; (syntax +icons +childframe)           ; tasing you for every semicolon you forget
       ;;(spell +flyspell) ; tasing you for mjsspelling mispelling
       ...
       data                ; config/data formats (for csv and xml)
       ...
       (org +roam2 +dragndrop +hugo +noter +pandoc +pomodoro +present +jupyter +passwords)               ; organize your plain life in plain text
